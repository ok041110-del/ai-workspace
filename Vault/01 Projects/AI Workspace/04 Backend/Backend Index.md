...
| Vault Integration | `src/ai_workspace/vault/` | GitHub↔Vault 문서 자동 저장(Router/Markdown Generator/Writer) + Auto Save Workflow(저장→Validation→완료 보고), Core Domain·`web/`을 모두 모름(M23, ADR-0035) |
